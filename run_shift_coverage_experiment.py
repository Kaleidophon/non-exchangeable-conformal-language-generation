"""
Perform distributional shift experiment, where we observe coverage under different magnitudes of noise added to model
embeddings.
"""
...
def perform_shift_experiment(
    ...
    """
    Perform the distributional shift experiment for coverage.
